...
export const routes: Routes = [
    ...
    {path: 'themes', loadComponent: () => import('./features/themes/theme-board/theme-board.component').then(c => c.ThemeBoardComponent) },
    {path: 'add-theme', loadComponent: () => import('./features/themes/new-theme/new-theme').then(c => c.NewTheme) },
